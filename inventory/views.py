...
from inventory.models import Item, PackingList, Profile, Category
from inventory.serializers import ItemSerializer, PackingListSerializer, ProfileSerializer, CategorySerializer
...
@api_view(['GET', 'PUT', 'DELETE'])
def packing_list_details(request, pk):
    try:
